L.Control.Geonames = L.Control.extend({
    ...
    options: {
        ...
        zoomLevel: 10, //Max zoom level to zoom to for location.  If null, will use the map's max zoom level.
    ...
    onAdd: function() {
        ...
        this._container.title = 'Busqueda por Locacion';
        ...
        input.type = 'text';
        input.placeholder = 'Ingrese el Lugar a Buscar';
