                ...
                <div class="card-body">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-sm-12">
                                <a href="/xadmin/paths/geocercasPorRuta/{{$IdRuta}}/geocercas" class="btn btn-primary pull-right">Ver todas las geocercas</a>
                                </p>
                                ...
                                <table class="table table-sm table-hover table-striped">
                                    ...
                                    <tbody name="tbodyRutas" id="tbodyRutas">
                                        ...
                                        <tr>
                                                    ...
                                                    <td width="10px"><a href="/xadmin/paths/quitarGeocerca/{{$IdRuta}}/{{$geocerca->IdGeocerca}}" class="btn btn-danger btn-sm">Quitar</a></td>
