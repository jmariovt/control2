                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <form class="form-group" method="POST" action="/xadmin/monitors/hojasDeRutaCliente/update" id="updateHojaRutaForm" name="updateHojaRutaForm">
                                @csrf
                                
                                <input class="form-control form-control-sm" type="hidden"  id="txtCliente" name="txtCliente" value='{{$cliente  ?? "" }}'>
                                <input class="form-control form-control-sm" type="hidden"  id="txtId" name="txtId" value='{{$id}}'>
                               
                                <?php
                                //$tipoCliente = session('hojaRuta_TipoCliente');
                                try {
                                    if($tipoCliente=="I" || $tipoCliente=="E") //Tipo = 'I'
                                ...
                                <div style="{{$styleButtonExcel}}" >
                                    <a href="/xadmin/monitors/exportHojaRuta/{{''}}/{{$tipoCliente}}/{{$cliente ?? '' }}" class="btn btn-success btn-sm">Exportar Excel</a>
                                </div>
                                <div style="{{$styleButtonEliminar}}" >
                                    <a href="/monitors/hojasDeRutaClientes/delete/ {{$cliente}}/{{$id}}" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar la hoja de ruta?')">Eliminar Plantilla</a>
                                </div>
                                    @csrf
                                    ...
                                    <div class="form-group" id="dispositivos" style="{{$styleDispositivos}}" >
                                        <label for="chkActivos">Seleccione la unidad:</label>
                                        <select class="form-control form-control-sm" id="chkActivos" name="chkActivos">
                                            @foreach($activos as $activo)
                                                <option value='{{$activo->Codigo}}' >{{$activo->Descripcion}}</option>
                                            @endforeach
                                            ...
                                            <div class="card-body">
                                                <table >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm" id="txtVehiculoPlaca" name="txtVehiculoPlaca" value="{{$datosCliente[0]->Placa ?? '' }}">
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <input type="text" class="form-control form-control-sm" name="txtNombrePlantilla" readonly value="{{$nombrePlantilla??''}}">
                                        </div>
                                    </div>
                                    
                                    <div class="modal-footer">
                                        <a href="/xadmin/monitors/hojasDeRutaClientes/admin/{{$cliente}}" class="btn btn-outline-secondary">Cancelar</a>
                                        <button type="submit" class="btn btn-primary">Actualizar Plantilla Hoja Ruta</button>
                                        <button type="button" class="btn btn-success" id="btn_Enviar" name="btn_Enviar">Enviar Hoja Ruta</button>
                                    </div>
                                </form>
                            </div>
                        </div>
