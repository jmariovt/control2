                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div style="{{$styleButtonExcel}}" >
                                    <a href="/xadmin/monitors/exportHojaRuta/{{''}}/{{''}}/{{$Cliente ?? '' }}" class="btn btn-success btn-sm">Exportar Excel</a>
                                </div>
                                <div style="{{$styleButtonEliminar}}" >
                                    <a href="/xadmin/monitors/eliminarHojaRuta/{{''}}/{{''}}" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar la hoja de ruta?')">Eliminar</a>
                                </div>
                                    @csrf
                                    ...
                                    <div class="form-group" id="dispositivos" style="{{$styleDispositivos}}" >
                                        <label for="chkNumeroDispositivos">Seleccione la unidad:</label>
