                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-sm-12">
                                <div class="modal-footer">
                                    <a href="/xadmin/postventa/paths/geocercasPorRuta/{{$IdRuta}}" class="btn btn-secondary btn-sm">Regresar</a>
                                </div>
                                ...
                                <table class="table table-sm table-hover table-striped">
                                    ...
                                    <tbody name="tbodyRutasGeocerca" id="tbodyRutasGeocerca">
                                        ...
                                        <tr>
                                            <form method="POST" class="form-group" action="/xadmin/postventa/paths/asignarGeocerca">
                                                 @csrf
