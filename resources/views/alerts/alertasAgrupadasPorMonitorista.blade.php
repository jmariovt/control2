                                                            ...
                                                            <select class="form-control-sm" id="agente" name="agente">
                                                                @foreach($agentes as $agente)
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        {
                                                                            if($nombreUsuario==$agente->Descripcion)
                                                                            {
                                                                    ?>
                                                                            <option value="{{$agente->Descripcion}}">{{$agente->Descripcion}}</option>
                                                                    <?php
                                    ...
                                    <table class="table table-condensed table-hover table-striped" id="tablaAlertas" name="tablaAlertas" width="100%" >
                                        <thead >
                                            <tr>
                                                ...
                                                <th width="8%">Alertas generadas</th>
                                                
                                                <th width="8%">Alertas gestionadas</th>
                                                <th width="8%">Alertas gestionadas por otro</th>
                                                <th width="8%">Alertas sin gestionar</th>
                                                <th width="4%">Tiempo promedio de respuesta meta</th>
                                                <th width="4%">Tiempo promedio de respuesta real</th>
                                                <th width="4%">Eficiencia</th>
                                                <th width="4%">Eficacia</th>
