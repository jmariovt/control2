...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    {
        Log::info("Mariolog: Entra a attempt en SessionGuard");
        ...
        if ($this->hasValidCredentials($user, $credentials)) {
            Log::info("Mariolog: hasValidCredentials ha dado true en SessionGuard. User: ".$user);
    ...
    protected function hasValidCredentials($user, $credentials)
    {
        ...
        if ($validated) {
            Log::info("Mariolog: credentials validadas");
    ...
    {
        Log::info("Mariolog: Ha entrado a login ".$user);
        $this->updateSession($user->getAuthIdentifier());

        Log::info("Mariolog: user->getAuthIdentifier ".$user->getAuthIdentifier());
    ...
    {
        Log::info("Mariolog: Entra a updateSession ".$id." + ".$this->getName());
        $this->session->put($this->getName(), $id);

        $this->session->migrate(true);
        Log::info("Mariolog: Finaliza  updateSession ".$id." + ".$this->getName());
    }
    ...
    {
        if (isset($this->events)) {
            Log::info("Mariolog: entro a isset(this->events) ".$this->name." ");
    ...
    {
        if (isset($this->events)) {
            Log::info('Mariolog en fireValidatedEvent. Nombre '.$this->name.'; User: '.$user);
    ...
    protected function fireLoginEvent($user, $remember = false)
    {
        ...
        if (isset($this->events)) {
            Log::info("Mariolog: fireLoginEvent ".$this->name." ".$user);
    ...
    {
        Log::info("Mariolog Entra a setUser. User: ".$user);
        $this->user = $user;
